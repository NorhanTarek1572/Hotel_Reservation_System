...
public class CheckOut extends javax.swing.JFrame {
    ...
    public CheckOut() {
        ...
        try{
            while(result.next())
            {
                Object[]  row  = {result.getString(1),result.getString(2),result.getString(3),result.getString(4),result.getString(5),result.getString(6),result.getString(7),result.getString(8)};
                model.addRow(row);
...
// search for guest by room num  
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            while(result.next())
            {
                if(result.getString(7).equals(roomNo)){
                    jTextField1.setEditable(false);
                    //To get  Name, price, and check-in date from check in 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Room.Update(r1.getNumber(),r1.getNumber(), r1.getType(),   r1.getPrice() , "Not-Booked");
        // Delete the Guest
        Guest.deleteGuest(r1.getNumber());
